...
/**
 * Component to handle workspace invitations for users.
 * - Retrieves invite code from URL params.
 * - Checks if the user is logged in.
 * - Allows joining the workspace via a mutation.
 * - Displays login/signup options if the user is not authenticated.
